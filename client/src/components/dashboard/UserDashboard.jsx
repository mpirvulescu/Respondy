        ...
        <div className="modal-header">
          <div className="modal-header__info">
            ...
            <div className="modal-subtitle">
              {call.phone_number} &middot; {new Date(call.created_at).toLocaleString()}
            </div>
          </div>
...
export default function UserDashboard() {
  ...
  useEffect(() => {
    ...
    fetchUserCalls(token).then((d) => setCalls(d.calls ?? [])).catch(handleAuthError);
  }, [token, logout]);
  ...
  const usagePercent = stats.apiCallsLimit > 0
    ...
    <>
      ...
      <div className="dashboard">
        ...
        <div className="page-header">
          ...
          <p className="page-header__subtitle">Manage your AI phone calls</p>
        </div>
            ...
            <div className="card__content">
              <div className="summary-rows">
                <div className="summary-row">
                  ...
                  <span className="summary-row__value">{callCounts.completed}</span>
                </div>
                <div className="summary-row">
                  <span className="summary-row__label">
                  ...
                  <span className="summary-row__value">{callCounts.failed}</span>
                </div>
                <div className="summary-row">
                  <span className="summary-row__label">
                  ...
                  <span className="summary-row__value">{callCounts.inProgress}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="card section">
          <div className="card__header">
            ...
            <p className="card__description">Provide a phone number and describe the goal for your AI agent.</p>
          </div>
          <div className="card__content">
              ...
              <div className="alert alert--warning">
                ...
                <div className="alert__text">
                  ...
                  <div className="alert__description">
                    You have used all {stats.apiCallsLimit} free calls.
                  </div>
                </div>
              </div>
            ) : (
              <form onSubmit={handleCall}>
                <div className="form-grid form-grid--2col" style={{ marginBottom: 16 }}>
                  <div className="form-group">
                    ...
                    />
                    <span className="form-helper">E.164 format recommended</span>
                  </div>
                  <div className="form-group">
                    <label className="form-label">Remaining Calls</label>
                    <input className="form-input" value={remaining} disabled />
                  </div>
                </div>
                ...
                <button className="btn btn--primary" type="submit" disabled={loading} style={{ width: '100%' }}>
                  {loading ? 'Initiating call\u2026' : '\u{1F4DE} Make Call'}
                </button>
              </form>
            )}
          </div>
          ...
          <div className="card__content--flush">
            {calls.length === 0 ? (
              <div className="empty-state">
                ...
                <div className="empty-state__text">Make your first call to get started</div>
              </div>
            ) : (
              <ul className="call-list">
                {calls.map((c) => (
                  <li key={c.id || c.callSid} className="call-row" onClick={() => setSelectedCall(c)}>
                    <div className="call-row__left">
                      <div className="call-row__icon">&#128222;</div>
                      <div className="call-row__info">
                        <div className="call-row__phone">{c.phone_number || c.to}</div>
                        <div className="call-row__goal">{c.goal || 'No goal specified'}</div>
                      </div>
                    </div>
                    <div className="call-row__right">
                      <StatusBadge status={c.status} />
                      <span className="call-row__date">{new Date(c.created_at).toLocaleDateString()}</span>
                      <span className="call-row__chevron">&#8250;</span>
                    </div>
                  </li>
                ))}
              </ul>
