    ...
    <form className="auth-form" onSubmit={handleSubmit} noValidate>
      ...
      {success ? (
        <>
          ...
          <button className="auth-form__link" type="button" onClick={onDone}>
            Back to sign in
          </button>
        </>
      ) : (
        <>
          <label className="auth-form__label">
            New password
            <input className="auth-form__input" type="password" value={password}
              onChange={(e) => setPassword(e.target.value)} placeholder="Min. 8 characters" autoComplete="new-password" />
          </label>
          <label className="auth-form__label">
            Confirm password
            <input className="auth-form__input" type="password" value={confirm}
